...
const PROVIDER_ICONS: Partial<Record<VideoProvider, string>> = {
  "wan-2.2": "🚀",
  "wan-2.2-fast": "⚡",
  "wan-2.5": "✨",
  "wan-2.5-fast": "🌟",
...
const PROVIDER_NAMES: Partial<Record<VideoProvider, string>> = {
  "wan-2.2": "Wan 2.2",
  "wan-2.2-fast": "Wan 2.2 Fast (6.8M runs)",
  "wan-2.5": "Wan 2.5",
  "wan-2.5-fast": "Wan 2.5 Fast",
  "kling-2.5-turbo": "Kling 2.5 Turbo Pro (1.7M runs)",
  "kling-2.6": "Kling 2.6 Pro (Audio)",
  "veo-2": "Google Veo 2",
  "veo-3": "Google Veo 3",
  "veo-3-fast": "Veo 3 Fast",
  "veo-3.1": "Google Veo 3.1 (Best Physics)",
  "veo-3.1-fast": "Veo 3.1 Fast (354K runs)",
  "hailuo-2.3": "Hailuo 2.3 Pro",
  "hailuo-2.3-fast": "Hailuo 2.3 Fast",
  "luma-ray-flash-2": "Luma Ray Flash 2",
  "ltx-2": "LTX-2 (Open Source)",
  "sora-2": "OpenAI Sora 2 (35s max)",
  "sora-2-pro": "OpenAI Sora 2 Pro",
  "hunyuan-1.5": "Hunyuan 1.5",
  "pixverse-4": "PixVerse 4",
  "seedance-1-pro": "Seedance 1 Pro (Lip-sync)",
  "seedance-1-lite": "Seedance 1 Lite",
};

const PROVIDER_COMPANIES: Partial<Record<VideoProvider, string>> = {
  "wan-2.2": "Alibaba",
  "wan-2.2-fast": "Alibaba",
  "wan-2.5": "Alibaba",
  "wan-2.5-fast": "Alibaba",
